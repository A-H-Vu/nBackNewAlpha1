...
expName = 'nBackNewAlpha1'  # from the Builder filename that created this script
...
for thisTaskLoop in taskLoop:
    ...
    for thisTrialsLoop in trialsLoop:
        ...
        # keep track of which components have finished
        trialComponents = [trialResp, trialGrid, trialSquare, trialFix]
